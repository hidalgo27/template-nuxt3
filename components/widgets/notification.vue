<template>
  ...
  <NotificationGroup group="foo">
    ...
    <button @click="notify">sdsd</button>
  </div>
</template>
...
// if (Props.notify_pros.title){
//   const varrr = ref(Props.notify_pros.title)
// }else{
//   const varrr = ref()
// }
// console.log(Props.notify_pros.title)

  const type = reactive({
    type: Props.notify_pros.title
  })
  // type.type = '3';
  //mounted
  // onMounted(async () => {
